...
export default function About() {
  return (
    ...
    <section id="about"  className="container py-5"       style={{height: "100vh", overflow: "auto" }}>
      <div className="row align-items-center">
        ...
        <div className="col-md-8">
          ...
          <p>
            I take what you want, figure out what you actually need, and deliver
            products that match your vision. With 4+ years of experience
            spanning enterprise-grade <strong>.NET applications</strong>,
            ...
            problem. That’s where I step in: bridging the gap between ideas and
            execution.
          </p>
          <p>
            My toolkit spans{" "}
            <strong>C#, .NET, UiPath, React, cloud services,</strong> and{" "}
            <strong>data platforms</strong>. Beyond writing clean code, I focus
            on listening, understanding, and building solutions that make lives
            easier.
          </p>
          <p>
